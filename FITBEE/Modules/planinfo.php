...
<script src='../editor/ckeditor.js'></script>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<button class="btn btn-info bg" type=submit name='save'> Save Topic  </button>
...
if(isset($_POST['save'])){
	...
	if(move_uploaded_file($temp,$filename)){
		//insert code 
$sql="Insert Into planinfo (plan_title,plan_image,plan_content,dietId) values
('$_POST[title]','$filename','$content','$_GET[dietid]')";
 if($conn->query($sql)){
